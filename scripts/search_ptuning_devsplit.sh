...
save_dir="ptuning_checkpoints/${few_shot_setting}/${model_type}_${task_name}_${method}_model"
...
do
    ...
    do
        ...
        --use_cloze \
        --fix_deberta \
        --cv_k 4 >myout_ptuning_${task_name}.file 2>&1 &
        wait
done
done
done
...
# nohup bash zj_search_ptuning_devsplit.sh rte 1 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh boolq 2 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh wic 3 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh wsc 4 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh cb 5 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh copa 6 deberta dev32_split >nohup.file 2>&1 &
# nohup bash zj_search_ptuning_devsplit.sh multirc 7 deberta dev32_split >nohup.file 2>&1 &
