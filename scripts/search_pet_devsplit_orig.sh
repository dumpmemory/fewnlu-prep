...
save_dir="0718_pet_checkpoints_fp16/${few_shot_setting}/${model_type}_${task_name}_${method}_model"
...
# bash search_pet_devsplit.sh boolq 7
# bash search_pet_devsplit.sh rte 1
# bash search_pet_devsplit.sh wic 2
# bash search_pet_devsplit.sh cb 3
# bash search_pet_devsplit.sh multirc 4
# bash search_pet_devsplit.sh wsc 5
# bash search_pet_devsplit.sh copa 6

# nohup bash search_pet_devsplit.sh boolq 7 >myout.file 2>&1 &
