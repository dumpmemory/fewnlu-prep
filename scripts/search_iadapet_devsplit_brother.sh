...
# nohup bash search_iadapet_devsplit_brother.sh boolq 0 1e-5 250 500 1 3 0.04 >myout.file 2>&1 &
# nohup bash search_iadapet_devsplit_brother.sh rte 1 5e-6 500 500 5 3 0.04 >myout.file 2>&1 &
# nohup bash search_iadapet_devsplit_brother.sh cb 3 1e-5 500 500 5 3 0.02 >myout.file 2>&1 &
# nohup bash search_iadapet_devsplit_brother.sh wic 5 5e-6 500 500 2 3 0.02 >myout.file 2>&1 &


# nohup bash search_iadapet_devsplit_brother.sh multirc 2 5e-6 500 500 0 3 0.02 >myout.file 2>&1 &
# nohup bash search_iadapet_devsplit_brother.sh wsc 6 1e-5 250 500 0 3 0.04 >myout.file 2>&1 &
# nohup bash search_iadapet_devsplit_brother.sh copa 4 5e-6 500 500 0 3 0.04 >myout.file 2>&1 &
