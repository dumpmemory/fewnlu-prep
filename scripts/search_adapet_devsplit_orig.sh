...
save_dir="0718_adapet_checkpoints/${few_shot_setting}/${model_type}_${task_name}_${method}_model"
...
SAMPLER_SEED="42"
SEED="42"
every_eval_ratios="0.02" #"0.02 0.04"
cv_k="4"
...
do
  ...
  do
    ...
    CUDA_VISIBLE_DEVICES=$device nohup python3 cli.py \
      ...
      --every_eval_ratio $every_eval_ratios \
      --cv_k $cv_k \
