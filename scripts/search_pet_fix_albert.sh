  ...
  do
    ...
    do
      ...
      do
        ...
        HYPER_PARAMS=${SEQ_LENGTH}_${MAX_STEP}_${TOTAL_TRAIN_BATCH}_${TRAIN_BATCH_SIZE}_${LR}_${PATTERN}_${cv_k}
...
# nohup bash search_pet_fix_albert.sh rte 0 1e-5 250 0 >myout.file 2>&1 &
# nohup bash search_pet_fix_albert.sh rte 1 1e-5 250 1 >myout.file 2>&1 &
# nohup bash search_pet_fix_albert.sh rte 2 1e-5 250 2 >myout.file 2>&1 &
# nohup bash search_pet_fix_albert.sh rte 3 1e-5 250 3 >myout.file 2>&1 &
# nohup bash search_pet_fix_albert.sh rte 6 1e-5 250 4 >myout.file 2>&1 &
# nohup bash search_pet_fix_albert.sh rte 7 1e-5 250 5 >myout.file 2>&1 &
