...
class TransformerModelWrapper:
    ...
    def _train(self, train_data, dev32_data, unlabeled_data,
               ...
               n_gpu, device, few_shot_setting, use_dropout=False, **_):
        # import pdb
        # pdb.set_trace()
        ...
        dev32_scores = self.evaluate(
            ...
            priming_num, priming_data=train_data)["scores"]
        ...
        if few_shot_setting == "fix_setting":
        ...
        for _ in train_iterator:
            ...
            for _, batch in enumerate(epoch_iterator):
                ...
                # if self.config.method == "lm_training":
                ...
                if (step + 1) % gradient_accumulation_steps == 0:
                    ...
                    if every_eval_step > 0 and global_step % every_eval_step == 0 and few_shot_setting != "fix_setting":
    ...
    def _eval(self, eval_data, device, per_gpu_eval_batch_size, n_gpu, eval_priming, priming_num, decoding_strategy) -> Dict:
        # import pdb 
        # pdb.set_trace()
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            with torch.no_grad():
                if self.config.method=='adapet':
                    ...
                    logits = self.task_helper.eval_step(batch, decoding_strategy=decoding_strategy) if (self.task_helper
    ...
    def _mask_tokens(self, original_input_ids, fake_labels=None, batch=None):
        ...
        if fake_labels is not None:
            if self.config.task_name not in ["wsc", "copa"]:
                ...
                for idx in range(len(input_ids)):
                    ...
                    input_ids[idx] = torch.where(input_ids[idx] == self.tokenizer.mask_token_id, lbl_choice, input_ids[idx])
