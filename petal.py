...
from task.tasks import PROCESSORS, load_examples, TRAIN_SET
from methods.utils import InputExample, eq_div
from methods.wrapper import TransformerModelWrapper, MODEL_CLASSES, WrapperConfig
import log
...
def main():
    ...
    parser.add_argument("--task_name", default=None, type=str, required=True,
                        help="The name of the data_utils to train selected in the list: " + ", ".join(PROCESSORS.keys()))
    ...
    parser.add_argument("--words_file", default=None, type=str,
                        help="Path to a file containing (unlabeled) texts from the data_utils's domain. This text is used to compute "
                             "verbalization candidates by selecting the most frequent words.")
    parser.add_argument("--max_words", default=10000, type=int,
                        help="Only the 10,000 tokens that occur most frequently in the data_utils’s unlabeled data (see --words_file) are "
